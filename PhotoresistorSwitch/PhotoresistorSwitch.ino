...
#define S_LED_PIN  13// defined as the signal led pin
#define BUTTON_PIN  3// define as buttun pin
#define P_RESISTOR_PIN  A2//define as the photoresistor pin
#define MOS_PIN  7//defined as the pin outputing to the mosfet
